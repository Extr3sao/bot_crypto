...
- **Crear**: `bdd/features/ohlcv_scheduler.feature` (nuevo archivo, **17 escenarios**: 12 originales + 3 nuevos para CL-9 negative + mixed-batch + runtime-mode-switch; el Sandbox-flag scenario se spliteo en 3 escenarios Connector/Backtest/Research, sumando +2 sobre los 12 originales).
...
- `pytest-bdd` ejecuta cada uno de los **17 escenarios** sin `uncollected` (cero skipped, cero errored).
- 100% de los RF-1..RF-10 + RF-7b tienen al menos un escenario.
