...
| 10 | **H1 regime-transition defense** (H1-REGIME-TRANSITION-DISCOVERY-01, commit 3ad054d prereg / b9e2760 execution) | **DISCOVERY_FAIL** (N=10193, 1 economic execution, marker-verified) | Gross expectancy −0.003 R ≈ 0 (no edge even before costs); net −0.128 R, PF_net 0.833, P(Sharpe>0)=0.0, halves/thirds uniformly negative; SHORT-on-CORRECTION/SHOCK leg (N=10058, net −0.129 R) bled against the structural 2020→2026 uptrend; LONG leg marginal (N=135, +0.018 R, PF 1.028 < 1.15) | Transition STATE alone carries no directional edge on 1h OHLCV: high-freq transitions (≈6.5/day qualifying) put cost drag (0.124 R) on top of a zero-gross mechanism; SHORT-fading-shock in a secular bull is structurally adverse. Any successor must condition direction on more than the transition label itself and clear the cost hurdle by lower frequency |
