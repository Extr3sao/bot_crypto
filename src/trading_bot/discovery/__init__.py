"""FRESH-DATA-001 — prospective discovery on strictly post-legacy data.
...
from .dataset import DataQualityReport, DatasetFetcher, build_data_manifest, sha256_candles
...
from .runner import DiscoveryRun, DiscoveryRunResult, evaluate_combo
